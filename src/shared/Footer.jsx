...
const Footer = () => {
   return (
      <div>
         <footer className="px-4 divide-y dark:bg-[#333333] dark:text-gray-100">
	...
	<div className="py-6 text-sm text-center bg-[#2A2A2A] dark:text-gray-400">© 1968 Company Co. All rights reserved.</div>
</footer>
      </div>
   );
};
